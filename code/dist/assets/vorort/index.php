...
if(isset($_GET['delete'])){
    if(!isset($_GET['sure'])){
        printf('Bist Du sicher? Soll die Datei %s wirklich gelöscht werden?<br> <a href="index.php?sure=1&delete=%s">Ja</a> - <a href="index.php">Nein</a>'
            , $_GET['delete']
            , $_GET['delete']
        );
            ...
            <div class="col-8 offset-2">
                ...
                <?php
                    ...
                    foreach($images as $image){
                        printf('<a href="index.php?delete=%s"><img src="%s" title="%s" class="celebrity"></a>'
                            , basename($image, '.png')
                            , $image
                            , basename($image)
                        );
