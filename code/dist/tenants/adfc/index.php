...
<head>
    ...
    <script>
        ...
        <?php printf('config.tenant="%s";', "adfc"); ?>
...
<body class="h-100 adfc">
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-adfc text-white">
...
<script src="<?php latestVersion('/assets/js/adfc.min.js');?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/adfc/%s`, () => {})', $_GET['usePicture']);
}
?>
