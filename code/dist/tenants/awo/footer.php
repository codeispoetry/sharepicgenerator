...
<footer class="bg-cockpitbg p-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-3">
                <img src="/assets/awo/logo-gerechter.png" class="img-fluid">
            </div>
            <div class="col-9">
                <p>
...
Hier können Sie ein Sharepic ("Ein Bild zum Teilen") erstellen und 
dieses herunterladen. Für die Gestaltung des Sharepics können Sie eine Forderung auswählen, 
einen persönlichen Text verfassen und ein individuelles Bild verwenden. 
Nach dem Download können Sie Ihr ganz persönliches Sharepic in den 
sozialen Medien posten, um die Forderungen an die Landesregierung zu unterstützen. <br>
