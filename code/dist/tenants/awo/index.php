            ...
            <div class="col-12 p-0 pt-3">
                <div id="canvas-area">
                    ...
                    <div class="text-center mt-5">
                        <div>
                            <button class="btn btn-awo btn-lg download bereitbold" id="download">
...
<script src="<?php latestVersion('/assets/js/awo.min.js');?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/awo/%s`, () => {})', $_GET['usePicture']);
}
?>
