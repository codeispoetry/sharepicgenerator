...
Rheinland-Pfalz</textarea>
        ...
        <h3 class="d-none" data-toggle="collapse" data-target=".logo"><i class="fas fa-fan"></i> Logo</h3>
        <div class="d-none logo expertmode collapse list-group-item list-group-item-action flex-column align-items-start">
...
grün</textarea>
        ...
        <h3 class="d-none collapsed" data-toggle="collapse" data-target=".addtext"><i class="fa fa-asterisk"></i> Sternchentext</h3>
