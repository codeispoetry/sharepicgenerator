...
<head>
    ...
    <script>
        ...
        <?php printf('config.tenant="%s";', "rlp"); ?>
...
<header>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <a class="navbar-brand arvo" href="/tenants/rlp">Sharepicgenerator.de</a>
...
<script src="/assets/js/rlp.min.js?v=<?php echo @filemtime('../../assets/js/rlp.min.js'); ?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/rlp/%s`, () => {})', $_GET['usePicture']);
}
?>
