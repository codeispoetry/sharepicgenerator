		...
		<div class="text list-group-item list-group-item-action flex-column align-items-start">   
			<div class="list-group-item-content">                 
				...
				<div class="d-flex">
					<textarea placeholder="Haupttext" name="text" id="text" class="form-control">Hier steht Dein Text.</textarea>
				...
				<div class="d-flex">
					<textarea placeholder="Text unter der Linie"  name="textafter" id="textafter" value="" class="form-control">Und hier auch.</textarea>
					<input type="hidden" name="textaftercolor" class="change-text" id="textaftercolor" value="<?php getColorAtIndex( 3 ); ?>">
					<span 
						class="colorpicker ms-1"  
