...
<div class="picture  list-group-item list-group-item-action flex-column align-items-start">
    <div class="mb-1 d-flex justify-content-between">
        ...
        <span class="colorpicker ms-1" data-colors="#008fcf,#e2ba00,#ffffff" data-action="background.drawColor()" data-field="#backgroundcolor" title="Bild löschen und Hintergrundfarbe setzen"></span> 
    </div>
 </div>
