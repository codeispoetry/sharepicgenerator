...
<div class="picture  list-group-item list-group-item-action flex-column align-items-start">
    <div class="mb-1 d-flex justify-content-between">
        <a href="#" class="btn btn-awo text-white text-awo cursor-pointer uploadfileclicker">
    ...
    <div>
        <div class="input-group -select-type">
            <div class="input-group-prepend">
                <button class="btn btn-outline-awo dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="picture  list-group-item list-group-item-action flex-column align-items-start">
    ...
    <div class="mt-2 mb-1 list-group-item-content show preferences-pic novideo">
        ...
        <div>
            <small class="text-awo cursor-pointer novideo me-5" id="backgroundflip"><i class="fas fa-exchange-alt"></i>
                spiegeln
            </small>
            <small class="text-awo cursor-pointer novideo" id="backgroundreset"><i class="fas fa-undo"></i></i>
                zurücksetzen
            </small>
        </div>
