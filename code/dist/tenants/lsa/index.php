...
<head>
    ...
    <script>
        ...
        <?php printf('config.tenant="%s";', "lsa"); ?>
...
<script src="/assets/js/lsa.min.js?v=<?php echo @filemtime('../../assets/js/lsa.min.js'); ?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/lsa/%s`, () => {})', $_GET['usePicture']);
}
?>
