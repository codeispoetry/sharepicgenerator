...
<div class="d-flex h-100">
  ...
  <div class="tab-content w-100 h-100 bg-cockpitbg" id="v-pills-tabContent">
    <div class="tab-pane show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
        <?php
            require_once(getBasePath('tenants/cockpit/nrw/picture.php'));
            require_once(getBasePath('tenants/cockpit/picture-size.php'));
        ?>
    </div>
    <div class="tab-pane" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
        <?php 
            require_once(getBasePath('tenants/cockpit/nrw/text.php'));
            require_once(getBasePath('tenants/cockpit/nrw/frame.php'));
            require_once(getBasePath('tenants/cockpit/nrw/logo.php'));
            require_once(getBasePath('tenants/cockpit/nrw/eyecatcher.php'));
        ?>
    </div>
    <div class="tab-pane" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
        <?php
            ...
            require_once(getBasePath('tenants/cockpit/nrw/addtext.php'));
