...
<head>
    ...
    <script>
        ...
        <?php printf('config.tenant="%s";', "basic"); ?>
...
<script src="/assets/js/basic.min.js?v=<?php echo @filemtime('../../assets/js/basic.min.js'); ?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/basic/%s`, () => {})', $_GET['usePicture']);
}
?>
