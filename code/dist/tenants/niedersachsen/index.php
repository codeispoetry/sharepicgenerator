...
<head>
    ...
    <script>
        ...
        <?php printf('config.tenant="%s";', "niedersachsen"); ?>
...
<script src="/assets/js/niedersachsen.min.js?v=<?php echo @filemtime('../../assets/js/niedersachsen.min.js'); ?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/niedersachsen/%s`, () => {})', $_GET['usePicture']);
}
?>
