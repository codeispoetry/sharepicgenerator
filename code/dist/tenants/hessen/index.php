...
<header>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <a class="navbar-brand arvo" href="/tenants/hessen">Sharepicgenerator.de/hessen</a>
...
<script src="/assets/js/hessen.min.js?v=<?php echo @filemtime('../../assets/js/hessen.min.js'); ?>"></script>
...
if (isset($_GET['usePicture'])) {
    printf('uploadFileByUrl(`../tenants/hessen/%s`, () => {})', $_GET['usePicture']);
}
?>
</script>
