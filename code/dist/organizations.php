...
<div class="container-fluid mb-5">
    <div class="row mt-5">
      <div class="col-md-8 offset-md-2 text-center">
        <h1 class="">Für Organisationen</h2>
      </div>
    </div>
    <div class="row mt-5">
      <div class="col-md-6 offset-md-3 mt-2 ">
          <h4>Sharepics im Corporate Design</h4>
            ...
            <p>
               <a href="MAILTO:tom.rose@sharepicgenerator.de" class="btn btn-primary btn-lg">Sprechen Sie uns an</a>
            </p>
