...
class ChromeSearch(unittest.TestCase):
    ...
    def test_1_download(self):
        driver = self.driver
        driver.get('http://127.0.0.1/vintage')
        ...
        select.select_by_visible_text('In Stream')
        time.sleep(1)

        # Insert texts
        driver.find_element_by_id('text').send_keys(Keys.CONTROL, 'a')
        driver.find_element_by_id('text').send_keys( u"Vintage rulez" )
